                    ...
                    <div class="table-responsive scrollbar">
                        <table class="table table-hover fs--1 mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center sort align-middle pe-0 text-end" scope="col" data-sort="date"
                                        style="width:15%; min-width:160px">Usuário</th>
                                    <th class="text-center sort align-middle pe-0 text-end" scope="col" data-sort="date"
                            ...
                            <tbody class="list" id="profile-order-table-body">
                                ...
                                <tr v-else v-for="pedido in pedidos.reverse()" :key="pedido.id"
                                    class="hover-actions-trigger btn-reveal-trigger position-static">
                                    <td class="order align-middle white-space-nowrap py-2 ps-0">
                                        <router-link class="fw-semi-bold text-primary" :to="{name: 'order-detail', params: { id: pedido.id }}">#{{ pedido.id }}</router-link>
                                    </td>
                                    ...
                                    <td class="text-center date align-middle text-700 text-end py-2">{{ getOrderUser(pedido.user) }}</td>
                                    <td class="text-center date align-middle text-700 text-end py-2">{{ formatDate(pedido.created) }}</td>
                                    <td class="text-center total align-middle fw-semi-bold text-end py-2 text-1000"> {{ getPrice(pedido.total) }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
